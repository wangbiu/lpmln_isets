...
def init_task_master(isc_config_file="isets-tasks.json", sleep_time=30):
    DistributedSearchIConditionsMaster.init_kmn_isc_task_master_from_config(DistributedSearchIConditionsMaster, isc_config_file, sleep_time)


def init_task_worker(isc_config_file="isets-tasks.json", is_check_valid_rules=True):
    DistributedSearchIConditionsWorker.init_kmn_isc_task_workers(DistributedSearchIConditionsWorker, isc_config_file, is_check_valid_rules)
