...
class NoWaitAugPreSkipDSearchMaster(AugumentedPreSkipI4DistributedSearchMaster):
...
class NoWaitAugPreSkipDSearchWorker(AugumentedPreSkipI4DistributedSearchWorker):
...
def init_task_master(isc_config_file="isets-tasks.json", sleep_time=30):
    NoWaitAugPreSkipDSearchMaster.init_kmn_isc_task_master_from_config(NoWaitAugPreSkipDSearchMaster, isc_config_file, sleep_time)


def init_task_worker(isc_config_file="isets-tasks.json", is_check_valid_rules=True):
    NoWaitAugPreSkipDSearchWorker.init_kmn_isc_task_workers(NoWaitAugPreSkipDSearchWorker, isc_config_file, is_check_valid_rules)
